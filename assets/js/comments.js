...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (commentForm) {
        commentForm.addEventListener('submit', function (e) {
            ...
            fetch('/controllers/submitComment.php', {
                method: 'POST',
                body: formData
            })
            .then(response => {
    ...
    function fetchComments(page = 1) {
        fetch(`/controllers/fetchComments.php?commentsID=${commentsID}&page=${page}`)
                ...
                data.comments.forEach(comment => {
                    ...
                    div.innerHTML = `
                        <div class="d-flex align-items-start mb-2">
                            <img class="avatar" src=/uploads/avatars/${comment.Avatar} alt="User Avatar" class="rounded me-3" width="50" height="75">
