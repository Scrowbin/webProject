...
function getBasePath() {
    ...
    // If we're in a subdirectory like /controllers/ or /views/
    if (path.includes('/controllers/') || path.includes('/views/')) {
        return '/';
    }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function performSearch(query) {
        ...
        fetch(`${basePath}controllers/search_controller.php?query=${encodeURIComponent(query)}`, {
            headers: {
    ...
    function displaySearchResults(results) {
        ...
        results.forEach(manga => {
            ...
            resultItem.innerHTML = `
                <img src="${basePath}manga/${manga.MangaID}/${manga.CoverLink}" alt="${manga.MangaNameOG}" class="search-result-cover">
