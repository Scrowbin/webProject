...
<aside id="nav-sidebar">
  <div class="sidebar-header">
    <a class="navbar-brand text-white fw-bold d-flex align-items-center sidebar-logo" href="/PHP/homepage.php"> <!-- Updated link -->
       MangaDax
    </a>
  ...
  <nav class="sidebar-nav">
      <a href="/PHP/homepage.php" class="nav-link active"><i class="bi bi-house-door-fill"></i> Home</a> <!-- Updated link -->
      <a href="#" class="nav-link"><i class="bi bi-bookmark-fill"></i> Follows</a>
      <a href="/PHP/latestUpdates.php" class="nav-link"><i class="bi bi-arrow-repeat"></i> Updates</a> <!-- Updated link -->
      ...
      <div class="sidebar-section">
          ...
          <div class="sub-links">
              ...
              <a href="/PHP/latestUpdates.php" class="nav-link">Latest Updates</a> <!-- Updated link -->
