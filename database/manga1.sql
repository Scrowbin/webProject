...
--
-- IMPORT INSTRUCTIONS (fixes error #1046 "No database selected")
--
-- Option A (recommended): In phpMyAdmin, click your database name in the
--   LEFT sidebar first (e.g. if0_42068234_manga on InfinityFree), then
--   open the Import tab and choose this file.
--
-- Option B: Uncomment exactly ONE USE line below for your environment:
--
-- USE `manga`;
-- USE `if0_42068234_manga`;
--
