...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/mangaInfo.css">
...
<body>
    ...
    <div class="container mt-3 ">
        <div class="d-flex align-items-center gap-2 flex-wrap">
            <div class="btn-wrapper">
                <form method="POST" action="/controllers/addToLibrary.php"
            ...
            <div class="btn-wrapper">
                <form method="POST" action="/controllers/submitRating.php"
    ...
    <form id="deleteForm" action="<?= $pathPrefix ?>controllers/handle_delete_manga.php" method="POST" style="display: none;">
    ...
    <div class="modal fade" id="reportModal" tabindex="-1" aria-labelledby="reportModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content rounded-4 shadow">
                <form id="reportForm" method="POST" action="<?= $pathPrefix ?>controllers/handle_report.php">
    ...
    <script src="/assets/js/navbar.js"></script> <!-- JS for Navbar -->
    <script src="/assets/js/sidebar.js"></script> <!-- JS for Sidebar -->
    <script src="/assets/js/search.js"></script> <!-- JS for Search -->
    <script>
        const mangaID = <?= json_encode($mangaID) ?>;
    </script>
    <script src="/assets/js/mangaInfo.js"></script>
