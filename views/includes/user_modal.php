    ...
    <div class="modal-content user-modal-content">
      <div class="modal-body user-modal-body">
        ...
        <div class="d-grid gap-2">
          <button class="btn btn-primary btn-user-action sign-in-btn" type="button">Sign In</button>
          <a href="#" class="text-center text-white-50 text-decoration-none small">Register</a>
        </div>
      </div>
    </div>
  </div>
