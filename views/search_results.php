...
<head>
  ...
  <link rel="stylesheet" href="<?= $pathPrefix ?>assets/css/search.css">
</head>
<body>
  <?php include $pathPrefix . 'views/includes/navbar.php'; ?>
  <?php include $pathPrefix . 'views/includes/sidebar.php'; ?>
          ...
          <div class="search-result-card">
            <div class="result-cover">
              <a href="<?= $pathPrefix ?>manga/<?= $manga['Slug'] ?>">
                <img src="<?= $pathPrefix ?>manga/<?= $manga['MangaID'] ?>/<?= htmlspecialchars($manga['CoverLink']) ?>" alt="<?= htmlspecialchars($manga['MangaNameOG']) ?>">
              </a>
            </div>
