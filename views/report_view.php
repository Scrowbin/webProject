...
$(document).ready(function() {
    ...
    function fetchMangaReports(page) {
        fetch(`../controllers/fetchReports.php?page=${page}`)
            ...
            .then(data => {
                ...
                data.mangaReports.forEach(report => {
                    ...
                    row.innerHTML = `
                        <td><a href="/manga/${report.Slug}"><img src="../manga/${report.MangaID}/${report.CoverLink}" height="50"></a></td>
            ...
            .then(data => {
                ...
                data.chapterReports.forEach(report => {
                    ...
                    row.innerHTML = `
                        ...
                        <td><a href="../controllers/mangaRead_controller.php?chapterID=${report.manga_id}">${report.ChapterName}</a></td>
                        <td>${report.ReportType}</td>
                        <td>${report.Username}</td>
                        <td>${report.Description}</td>
                        <td><button class="btn btn-success btn-sm resolve-btn">Resolved</button></td>
    ...
    $(document).ready(function() {
        $(document).on('click', '.resolve-btn', function() {    
            ...
            $.ajax({
                url: '../controllers/resolve_report.php',
                method: 'POST',
                data: { reportID, type },
