...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/staff_pick.css">
</head>
<body>
    <?php include __DIR__ . '/includes/navbar_minimal.php'; ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="staff-pick-card">
                                        <div class="d-flex">
                                            <img src="/manga/<?= $pick['MangaID'] ?>/<?= htmlspecialchars($pick['CoverLink']) ?>" alt="<?= htmlspecialchars($pick['MangaNameOG']) ?>" class="staff-pick-img" style="width: 120px; height: auto; object-fit: cover;">
