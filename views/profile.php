...
<body class="bg-dark">
    <?php
    include __DIR__ . '/includes/navbar_minimal.php';
    ?>
    ...
    <div class="container-fluid mt-5">
        <div class="row">
            ...
            <div class="col-md-9 col-lg-10">
                <form action="controllers/auth_controller.php?action=profile" method="POST" class="profile-form">
                                ...
                                <div class="avatar-container mb-2">
                                    <div class="avatar-wrapper bg-warning text-center d-inline-block" style="width: 100px; height: 100px; line-height: 100px; font-size: 48px; color: white;" id="avatar" data-username="<?php echo htmlspecialchars($user_data['username']); ?>">
                                        <?php if (!empty($user_data['Avatar']) && $user_data['Avatar'] !== 'avatar_default.png'): ?>
                                            <img src="/uploads/avatars/<?php echo htmlspecialchars($user_data['Avatar']); ?>" class="w-100 h-100" style="object-fit: cover;">
                                        <?php else: ?>
                            ...
                            <div class="col-sm-9">
                                <div class="banner-container mb-2">
                                    <?php if (!empty($user_data['banner'])): ?>
                                        <img src="/uploads/banners/<?php echo htmlspecialchars($user_data['banner']); ?>" alt="Profile Banner" class="img-fluid rounded" id="currentBanner">
                                    <?php else: ?>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div id="avatar-preview-container" class="avatar-preview-container mb-3">
                                <?php if (!empty($user_data['Avatar']) && $user_data['Avatar'] !== 'avatar_default.png'): ?>
                                    <img id="previewAvatar" src="/uploads/avatars/<?php echo htmlspecialchars($user_data['Avatar']); ?>" class="avatar draggable-avatar">
                                <?php else: ?>
                                    <img id="previewAvatar" src="/assets/static/avatar_default.png" class="avatar">
                                <?php endif; ?>
                            </div>
                        </div>
                        <div class="col-md-8">
            ...
            <div class="modal-content bg-dark text-white">
                ...
                <div class="modal-body p-4">
                    ...
                    <div id="banner-preview-container" class="banner-preview-container mb-3">
                        <?php if (!empty($user_data['banner'])): ?>
                            <img id="previewBanner" src="/uploads/banners/<?php echo htmlspecialchars($user_data['banner']); ?>" class="draggable-banner">
                        <?php else: ?>
