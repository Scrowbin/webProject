...
<head>
    ...
    <link rel="stylesheet" href="<?= $pathPrefix ?>assets/css/navbar.css">
    <link rel="stylesheet" href="<?= $pathPrefix ?>assets/css/library.css">
    <link rel="stylesheet" href="<?= $pathPrefix ?>assets/css/advanced_search.css">
</head>
<body>
                    ...
                    <div class="manga-card">
                        <div class="manga-cover">
                            <a href="<?= $pathPrefix ?>manga/<?=$mangaSlug?>">
                                <img src="<?= $pathPrefix ?>manga/<?=$mangaID?>/<?=$CoverLink?>" alt="Manga Cover">
                            </a>
                        </div>
    ...
    <script src="<?= $pathPrefix ?>assets/js/navbar.js"></script>
    <script src="<?= $pathPrefix ?>assets/js/sidebar.js"></script>
    <script src="<?= $pathPrefix ?>assets/js/search.js"></script>
    <script src="<?= $pathPrefix ?>assets/js/library.js"></script>
    <script src="<?= $pathPrefix ?>assets/js/advanced_search.js"></script>
</body>
</html>
