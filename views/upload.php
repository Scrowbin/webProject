...
<div class="container bg-white p-4 rounded shadow-sm mt-4">
  ...
  <a href="/manga/<?=$slug?>">
    <div class="d-flex align-items-center border rounded p-3 mb-4">
        <img src="/manga/<?=$mangaID?>/<?=$image?>" alt="Manga Cover" class="me-3" style="width: 60px; height: 90px; object-fit: cover;">
        <div>
  ...
  if (mode === "edit") {
    form.action = "/controllers/editChapter.php";
  } else {
    form.action = "/controllers/uploadChapter.php";
  }
  ...
  <script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
      ...
      <?php
        ...
        $chapterDir = "/manga/$mangaID/$chapterNumber"; // adjust as needed
      ?>
      const previewContainer = document.getElementById('pagePreview');
      previewContainer.innerHTML = '';
