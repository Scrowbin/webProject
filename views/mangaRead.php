...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/mangaRead.css">
</head>
        ...
        <main>
            ...
            <div class="" id="page-container">
                    ...
                    for($i=0;$i<count($pages);$i++){
                        ?>
                        <img src="/manga/<?=$mangaID?>/<?=$chapterNumber?>/<?=$pageLinks[$i]?>" class="img-fit-width" id="page-<?=$i+1?>" alt="Page <?=$i+1?>">
                        <?php
                    }
                    ?>
            </div>
...
<script src="/assets/js/mangaRead.js"></script>
