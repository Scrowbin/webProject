...
try {
    ...
    $mangaImageDir = MANGA_PATH . DIRECTORY_SEPARATOR . $mangaID . DIRECTORY_SEPARATOR;
    $folderDeleted = true;
    ...
    header("Location: ../views/deleteManga.php?success=0&message=" . urlencode($e->getMessage()));
    exit;
}