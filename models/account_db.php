    ...
    try {
        ...
        if (isset($data['avatar'])) {
            ...
            if ($currentUserData && !empty($currentUserData['Avatar']) &&
                ...
                $oldAvatarPath = UPLOADS_PATH . DIRECTORY_SEPARATOR . 'avatars' . DIRECTORY_SEPARATOR . $currentUserData['Avatar'];
        ...
        if (isset($data['banner'])) {
            ...
            if ($currentUserData && !empty($currentUserData['banner'])) {
                $oldBannerPath = UPLOADS_PATH . DIRECTORY_SEPARATOR . 'banners' . DIRECTORY_SEPARATOR . $currentUserData['banner'];
...
function save_base64_image(string $base64Data, string $folder, int $userID): string
{
    ...
    if (preg_match('/^data:image\/(\w+);base64,/', $base64Data, $matches)) {
        ...
        $uploadDir = UPLOADS_PATH . DIRECTORY_SEPARATOR . $folder . DIRECTORY_SEPARATOR;
